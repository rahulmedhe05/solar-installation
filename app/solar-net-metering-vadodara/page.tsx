...
const keyword = getKeywordBySlug("solar-net-metering-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/solar-net-metering-vadodara",
  },
...
export default function SolarNetMeteringVadodaraPage() {
