...
const keyword = getKeywordBySlug("bifacial-solar-panel-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/bifacial-solar-panel-vadodara",
  },
...
export default function BifacialSolarPanelVadodaraPage() {
