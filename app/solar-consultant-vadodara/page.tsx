...
const keyword = getKeywordBySlug("solar-consultant-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/solar-consultant-vadodara",
  },
...
export default function SolarConsultantVadodaraPage() {
