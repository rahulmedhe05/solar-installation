...
const keyword = getKeywordBySlug("industrial-solar-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/industrial-solar-vadodara",
  },
...
export default function IndustrialSolarVadodaraPage() {
