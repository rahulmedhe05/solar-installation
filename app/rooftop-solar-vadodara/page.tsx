...
const keyword = getKeywordBySlug("rooftop-solar-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/rooftop-solar-vadodara",
  },
...
export default function RooftopSolarVadodaraPage() {
