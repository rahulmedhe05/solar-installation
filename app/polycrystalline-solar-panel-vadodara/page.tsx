...
const keyword = getKeywordBySlug("polycrystalline-solar-panel-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/polycrystalline-solar-panel-vadodara",
  },
...
export default function PolycrystallineSolarPanelVadodaraPage() {
