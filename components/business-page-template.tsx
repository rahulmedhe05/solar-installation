...
import { AreaBreadcrumbs } from "./breadcrumbs";
...
// Solar installation images from Unsplash - all unique and verified working
const solarImages = {
  // About section - solar technician working
  about: "https://images.unsplash.com/photo-1509391366360-2e959784a276?w=600&h=500&fit=crop",
  
  // Project gallery images - 4 unique solar installations
  projects: [
    "https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?w=600&h=400&fit=crop", // solar panels field
    "https://images.unsplash.com/photo-1559302504-64aae6ca6b6d?w=600&h=400&fit=crop", // rooftop solar
    "https://images.unsplash.com/photo-1497440001374-f26997328c1b?w=600&h=400&fit=crop", // solar farm
    "https://images.unsplash.com/photo-1548098343-8c8b6abe8ebf?w=600&h=400&fit=crop", // solar panel closeup
  ],
  
  // Before/After - rooftops
  before: [
    "https://images.unsplash.com/photo-1449844908441-8829872d2607?w=600&h=400&fit=crop", // empty rooftop house
    "https://images.unsplash.com/photo-1570129477492-45c003edd2be?w=600&h=400&fit=crop", // another empty roof house
  ],
  after: [
    "https://images.unsplash.com/photo-1611365892117-00ac6fb5544d?w=600&h=400&fit=crop", // house with solar
    "https://images.unsplash.com/photo-1595437193398-f24279553f4f?w=600&h=400&fit=crop", // modern house solar
  ],
  
  // Why choose us - solar energy concept
  why: "https://images.unsplash.com/photo-1532601224476-15c79f2f7a51?w=600&h=600&fit=crop",
  
  // Local area images - 4 unique
  local: [
    "https://images.unsplash.com/photo-1566093097221-ac2335b09e70?w=300&h=300&fit=crop", // solar installation
    "https://images.unsplash.com/photo-1624397640148-949b1732bb0a?w=300&h=300&fit=crop", // solar worker
    "https://images.unsplash.com/photo-1613665813446-82a78c468a1d?w=300&h=300&fit=crop", // solar panels array
    "https://images.unsplash.com/photo-1473341304170-971dccb5ac1e?w=300&h=300&fit=crop", // wind and solar
  ],
  
  // CTA banner
  cta: "https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?w=1920&h=600&fit=crop",
  
  // Areas section - 10 unique solar images for area cards
  areas: [
    "https://images.unsplash.com/photo-1509391111738-29ae7c3bb1b2?w=300&h=200&fit=crop", // solar on roof
    "https://images.unsplash.com/photo-1581093588401-fbb62a02f120?w=300&h=200&fit=crop", // solar technician
    "https://images.unsplash.com/photo-1592833159117-ac860e2dee30?w=300&h=200&fit=crop", // solar farm aerial
    "https://images.unsplash.com/photo-1604134967494-8a9c4b2c7c3f?w=300&h=200&fit=crop", // house with panels
    "https://images.unsplash.com/photo-1545208942-e1c9c916524b?w=300&h=200&fit=crop", // commercial solar
    "https://images.unsplash.com/photo-1579373903781-fd5c0c30c4cd?w=300&h=200&fit=crop", // solar panel install
    "https://images.unsplash.com/photo-1611365892117-00ac6fb5544d?w=300&h=200&fit=crop", // residential solar
    "https://images.unsplash.com/photo-1595437193398-f24279553f4f?w=300&h=200&fit=crop", // modern solar home
    "https://images.unsplash.com/photo-1632406897798-76ac68e8a43e?w=300&h=200&fit=crop", // solar panel rows
    "https://images.unsplash.com/photo-1633113215883-a43e36bc9f9a?w=300&h=200&fit=crop", // rooftop installation
  ],
};
...
export function BusinessPageTemplate({ business, area, content }: BusinessPageTemplateProps) {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      {/* SEO Schemas */}
      <FAQSchema faqs={content.faqItems} />
      <ServiceSchema 
        name={`${business.name} in ${areaName}`} 
        description={content.aboutContent.substring(0, 200)} 
        areaServed={areaName}
      />
      ...
      <div className="container mx-auto px-4 pt-4">
        <AreaBreadcrumbs areaName={areaName} />
      </div>
      ...
      <section className="py-16 md:py-20">
        <div className="container mx-auto px-4">
          ...
          <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
            Take a look at some of our best {business.name.toLowerCase()} projects completed in {locationText}
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[0, 1, 2, 3].map((i) => (
              <div key={i} className="relative group overflow-hidden rounded-xl shadow-lg">
                <img
                  src={solarImages.projects[i]}
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity">
                  <div className="absolute bottom-4 left-4 text-white">
                    ...
                    <p className="text-sm opacity-80">{locationText}</p>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4 max-w-6xl mx-auto mb-6">
            {business.areas
              ...
              .map((otherArea, index) => (
                ...
                >
                  <img
                    src={solarImages.areas[index % solarImages.areas.length]}
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              ...
              <div className="flex flex-col items-center p-6 bg-white/10 rounded-xl">
                ...
                <p className="opacity-90">{locationText}</p>
              </div>
            </div>
            <a
