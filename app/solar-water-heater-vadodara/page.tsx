...
const keyword = getKeywordBySlug("solar-water-heater-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/solar-water-heater-vadodara",
  },
...
export default function SolarWaterHeaterVadodaraPage() {
