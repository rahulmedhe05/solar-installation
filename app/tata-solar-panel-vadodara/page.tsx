...
const keyword = getKeywordBySlug("tata-solar-panel-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/tata-solar-panel-vadodara",
  },
...
export default function TataSolarPanelVadodaraPage() {
