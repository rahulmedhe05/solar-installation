...
const keyword = getKeywordBySlug("waaree-solar-panel-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/waaree-solar-panel-vadodara",
  },
...
export default function WaareeSolarPanelVadodaraPage() {
