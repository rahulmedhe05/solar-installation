...
const keyword = getKeywordBySlug("lithium-battery-solar-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/lithium-battery-solar-vadodara",
  },
...
export default function LithiumBatterySolarVadodaraPage() {
