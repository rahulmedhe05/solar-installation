...
const keyword = getKeywordBySlug("25kw-solar-system-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/25kw-solar-system-vadodara",
  },
...
export default function TwentyFiveKwSolarSystemVadodaraPage() {
