...
const keyword = getKeywordBySlug("on-grid-solar-system-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/on-grid-solar-system-vadodara",
  },
...
export default function OnGridSolarSystemVadodaraPage() {
