...
import { KeywordBreadcrumbs } from "./breadcrumbs";
import { FAQSchema, ServiceSchema, ProductSchema } from "./seo-schemas";
import { Phone, Mail, MapPin, CheckCircle, Star, Users, Award, Clock, Tag, Sparkles, Image as ImageIcon } from "lucide-react";
import { cn } from "@/lib/utils";
import Link from "next/link";

// Solar installation images from Unsplash
const solarImages = {
  banner: "https://images.unsplash.com/photo-1509391366360-2e959784a276?w=1920&h=600&fit=crop",
  about: "https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?w=600&h=500&fit=crop",
  projects: [
    ...
    "https://images.unsplash.com/photo-1548098343-8c8b6abe8ebf?w=600&h=400&fit=crop",
    "https://images.unsplash.com/photo-1566093097221-ac2335b09e70?w=600&h=400&fit=crop",
  ...
  why: "https://images.unsplash.com/photo-1559302504-64aae6ca6b6d?w=600&h=600&fit=crop",
  areas: [
    "https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?w=300&h=200&fit=crop",
    "https://images.unsplash.com/photo-1559302504-64aae6ca6b6d?w=300&h=200&fit=crop",
    "https://images.unsplash.com/photo-1497440001374-f26997328c1b?w=300&h=200&fit=crop",
    "https://images.unsplash.com/photo-1548098343-8c8b6abe8ebf?w=300&h=200&fit=crop",
    "https://images.unsplash.com/photo-1566093097221-ac2335b09e70?w=300&h=200&fit=crop",
    "https://images.unsplash.com/photo-1624397640148-949b1732bb0a?w=300&h=200&fit=crop",
    "https://images.unsplash.com/photo-1613665813446-82a78c468a1d?w=300&h=200&fit=crop",
    "https://images.unsplash.com/photo-1509391111738-29ae7c3bb1b2?w=300&h=200&fit=crop",
  ...
  cta: "https://images.unsplash.com/photo-1509391366360-2e959784a276?w=1920&h=600&fit=crop",
};
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="container mx-auto px-4 pt-4">
        <KeywordBreadcrumbs keywordTitle={keyword.title} />
      </div>
