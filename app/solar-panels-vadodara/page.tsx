...
const keyword = getKeywordBySlug("solar-panels-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/solar-panels-vadodara",
  },
...
export default function SolarPanelsVadodaraPage() {
