...
const keyword = getKeywordBySlug("100kw-solar-system-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/100kw-solar-system-vadodara",
  },
...
export default function HundredKwSolarSystemVadodaraPage() {
