...
const keyword = getKeywordBySlug("2kw-solar-system-price-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/2kw-solar-system-price-vadodara",
  },
...
export default function TwoKwSolarSystemPriceVadodaraPage() {
