...
const keyword = getKeywordBySlug("zero-electricity-bill-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/zero-electricity-bill-vadodara",
  },
...
export default function ZeroElectricityBillVadodaraPage() {
