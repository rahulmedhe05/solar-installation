...
const keyword = getKeywordBySlug("solar-subsidy-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/solar-subsidy-vadodara",
  },
...
export default function SolarSubsidyVadodaraPage() {
