...
const keyword = getKeywordBySlug("adani-solar-panel-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/adani-solar-panel-vadodara",
  },
...
export default function AdaniSolarPanelVadodaraPage() {
