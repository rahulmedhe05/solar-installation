...
const keyword = getKeywordBySlug("solar-financing-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/solar-financing-vadodara",
  },
...
export default function SolarFinancingVadodaraPage() {
