...
const keyword = getKeywordBySlug("affordable-solar-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/affordable-solar-vadodara",
  },
...
export default function AffordableSolarVadodaraPage() {
