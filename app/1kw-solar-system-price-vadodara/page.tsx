...
const keyword = getKeywordBySlug("1kw-solar-system-price-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/1kw-solar-system-price-vadodara",
  },
...
export default function OneKwSolarSystemPriceVadodaraPage() {
