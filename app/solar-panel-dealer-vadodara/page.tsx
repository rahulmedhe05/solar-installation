...
const keyword = getKeywordBySlug("solar-panel-dealer-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/solar-panel-dealer-vadodara",
  },
...
export default function SolarPanelDealerVadodaraPage() {
