...
const keyword = getKeywordBySlug("3kw-solar-system-price-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/3kw-solar-system-price-vadodara",
  },
...
export default function ThreeKwSolarSystemPriceVadodaraPage() {
