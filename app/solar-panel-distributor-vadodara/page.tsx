...
const keyword = getKeywordBySlug("solar-panel-distributor-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/solar-panel-distributor-vadodara",
  },
...
export default function SolarPanelDistributorVadodaraPage() {
