...
const keyword = getKeywordBySlug("50kw-solar-system-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/50kw-solar-system-vadodara",
  },
...
export default function FiftyKwSolarSystemVadodaraPage() {
