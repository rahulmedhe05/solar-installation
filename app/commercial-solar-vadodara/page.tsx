...
const keyword = getKeywordBySlug("commercial-solar-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/commercial-solar-vadodara",
  },
...
export default function CommercialSolarVadodaraPage() {
