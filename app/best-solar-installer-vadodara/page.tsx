...
const keyword = getKeywordBySlug("best-solar-installer-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/best-solar-installer-vadodara",
  },
...
export default function BestSolarInstallerVadodaraPage() {
