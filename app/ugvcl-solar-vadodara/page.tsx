...
const keyword = getKeywordBySlug("ugvcl-solar-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/ugvcl-solar-vadodara",
  },
...
export default function UgvclSolarVadodaraPage() {
