...
const keyword = getKeywordBySlug("hybrid-solar-system-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/hybrid-solar-system-vadodara",
  },
...
export default function HybridSolarSystemVadodaraPage() {
