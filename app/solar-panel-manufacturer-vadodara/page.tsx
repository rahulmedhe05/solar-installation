...
const keyword = getKeywordBySlug("solar-panel-manufacturer-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/solar-panel-manufacturer-vadodara",
  },
...
export default function SolarPanelManufacturerVadodaraPage() {
