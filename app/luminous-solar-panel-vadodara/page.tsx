...
const keyword = getKeywordBySlug("luminous-solar-panel-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/luminous-solar-panel-vadodara",
  },
...
export default function LuminousSolarPanelVadodaraPage() {
