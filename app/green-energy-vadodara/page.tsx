...
const keyword = getKeywordBySlug("green-energy-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/green-energy-vadodara",
  },
...
export default function GreenEnergyVadodaraPage() {
