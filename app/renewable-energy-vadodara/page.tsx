...
const keyword = getKeywordBySlug("renewable-energy-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/renewable-energy-vadodara",
  },
...
export default function RenewableEnergyVadodaraPage() {
