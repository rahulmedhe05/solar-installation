...
const keyword = getKeywordBySlug("solar-for-flat-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/solar-for-flat-vadodara",
  },
...
export default function SolarForFlatVadodaraPage() {
