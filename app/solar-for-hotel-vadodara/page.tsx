...
const keyword = getKeywordBySlug("solar-for-hotel-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/solar-for-hotel-vadodara",
  },
...
export default function SolarForHotelVadodaraPage() {
