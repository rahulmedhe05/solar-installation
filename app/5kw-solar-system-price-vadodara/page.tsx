...
const keyword = getKeywordBySlug("5kw-solar-system-price-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/5kw-solar-system-price-vadodara",
  },
...
export default function FiveKwSolarSystemPriceVadodaraPage() {
