...
const keyword = getKeywordBySlug("best-solar-company-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/best-solar-company-vadodara",
  },
...
export default function BestSolarCompanyVadodaraPage() {
