...
const keyword = getKeywordBySlug("solar-panel-installation-cost-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/solar-panel-installation-cost-vadodara",
  },
...
export default function SolarPanelInstallationCostVadodaraPage() {
