...
const keyword = getKeywordBySlug("solar-for-school-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/solar-for-school-vadodara",
  },
...
export default function SolarForSchoolVadodaraPage() {
