...
const keyword = getKeywordBySlug("top-solar-company-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/top-solar-company-vadodara",
  },
...
export default function TopSolarCompanyVadodaraPage() {
