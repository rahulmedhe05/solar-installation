...
const keyword = getKeywordBySlug("solar-ac-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/solar-ac-vadodara",
  },
...
export default function SolarAcVadodaraPage() {
