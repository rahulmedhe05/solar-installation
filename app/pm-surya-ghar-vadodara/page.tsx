...
const keyword = getKeywordBySlug("pm-surya-ghar-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/pm-surya-ghar-vadodara",
  },
...
export default function PmSuryaGharVadodaraPage() {
