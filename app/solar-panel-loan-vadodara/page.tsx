...
const keyword = getKeywordBySlug("solar-panel-loan-vadodara")!;
const business = getBusinessBySlug("solar-installation")!;

export const metadata: Metadata = {
  alternates: {
    canonical: "https://solarinstallationvadodara.in/solar-panel-loan-vadodara",
  },
...
export default function SolarPanelLoanVadodaraPage() {
